...
- Kotest helped to cover the gap when I had to have the same tests in multiple platforms
  - See [SpringServerIntegrationTest](server/spring/src/test/kotlin/br/com/gabryel/reginaesanguine/server/SpringServerIntegrationTest.kt)
  - See [NodeServerIntegrationTest](server/node/src/jsTest/kotlin/br/com/gabryel/reginaesanguine/server/NodeServerIntegrationTest.kt)
...
- Different ways of interacting cause different implementations per type of interaction
  - See [ActionableTooltip](app/compose/src/commonMain/kotlin/br/com/gabryel/reginaesanguine/app/ui/components/ActionableTooltip.kt)
    ...
    - For touch based devices, button is kept as a Tooltip action
...
- Debugging in Node is a lot harder
...
- Using KMP is highly contextual, depends on how easy is to justify multiple targets
