 ...
 */
class RemoteGameClient(private val client: ServerClient) : GameClient {
    ...
    ): GameViewDto = client.post(
        "game/$gameId/action",
        ActionDto.from(action),
        mapOf("Authorization" to playerPosition.name),
    )
