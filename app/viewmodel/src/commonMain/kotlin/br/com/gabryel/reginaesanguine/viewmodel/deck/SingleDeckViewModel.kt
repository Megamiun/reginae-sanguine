...
class SingleDeckViewModel(
    val pack: Pack,
    private val viewFlow: MutableStateFlow<ViewDecks> =
        MutableStateFlow(ViewDecks(Array(6) { pack.cards.filter { !it.spawnOnly }.take(15) }.toList())),
