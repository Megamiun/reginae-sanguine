...
fun getCardSize(height: Dp = DEFAULT_CARD_SIZE, ratio: Float = WIDTH_PER_HEIGHT_RATIO) =
    DpSize(height * ratio, height)

fun getCardSizeByWidth(width: Dp = DEFAULT_CARD_SIZE, ratio: Float = HEIGHT_PER_WIDTH_RATIO) =
