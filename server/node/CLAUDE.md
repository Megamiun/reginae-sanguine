...
- **Admin Pack Management**: `POST /admin/seed-packs` - Seed card packs into database
- **Pack Listing**: `GET /pack?page={page}&size={size}` - Paginated pack listing
- **Deck Management**: `GET /decks/{deckId}` - Get deck details
